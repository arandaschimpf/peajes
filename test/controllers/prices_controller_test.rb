...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { car_id: @price.car_id, from: @price.from, to: @price.to } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { car_id: @price.car_id, from: @price.from, to: @price.to } }
